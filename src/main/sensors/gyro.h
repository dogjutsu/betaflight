...
typedef struct gyroConfig_s {
    ...
    uint8_t  dyn_notch_stdby_width_percent;
    uint16_t dyn_notch_stdby_q;
    uint16_t dyn_notch_stdby_static_hz;
    uint16_t dyn_notch_stdby_trigger;
    uint16_t dyn_notch_mute_trigger;    
